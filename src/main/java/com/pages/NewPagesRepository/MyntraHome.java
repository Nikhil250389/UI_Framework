...
public class MyntraHome extends BaseTest {
	...
	@FindBy(xpath = "//div[@class='desktop-navContent']")
	private List<WebElement> homePageHeader;

	@FindBy(xpath = "//div[@class='myx-indexContainer']")
...
/*
	...
	*/
	...
	public List<WebElement> MenHomePageProducts() {
		log.info("Total Men Home Page Products displayed");
